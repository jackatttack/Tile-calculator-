...
class KeyboardItem(ui.View):
    ...
    def __init__(self, board, spec, size):
        ...
        preview = Tile(
            ...
            kind=display_kind,
            color=Tile.color_for_kind(display_kind),
            cell_size=int(size),
            w_cells=1,
            h_cells=1,
            gutter=4,
    ...
    PAGES = [
        {
            ...
            'rows': [
                [
                    {'text': 'x',    'kind': 'expr',       'expr_str': 'x',         'display': 'x'},
                    {'text': 'pi',   'kind': 'irrational', 'expr_str': 'pi',        'display': 'pi',
                     '_meta': {'exact_expr': 'pi', 'showing_decimal': False}},
                    {'text': 'fact', 'kind': 'tool',       'expr_str': 'factor',    'display': 'fact'},
                    {'text': 'rand', 'kind': 'tool',       'expr_str': 'random',    'display': 'rand'},
                    {'text': 'sqrt', 'kind': 'tool',       'expr_str': 'sqrt',      'display': 'sqrt'},
                ],
                [
                    {'text': '7',  'kind': 'number', 'expr_str': '7',  'display': '7'},
                    {'text': '8',  'kind': 'number', 'expr_str': '8',  'display': '8'},
                    {'text': '9',  'kind': 'number', 'expr_str': '9',  'display': '9'},
                    {'text': '+',  'kind': 'op',     'expr_str': '+',  'display': '+'},
                    {'text': '-',  'kind': 'op',     'expr_str': '-',  'display': '-'},
                ],
                [
                    {'text': '4',  'kind': 'number', 'expr_str': '4',  'display': '4'},
                    {'text': '5',  'kind': 'number', 'expr_str': '5',  'display': '5'},
                    {'text': '6',  'kind': 'number', 'expr_str': '6',  'display': '6'},
                    {'text': 'x',  'kind': 'op',     'expr_str': '*',  'display': 'x'},
                    {'text': '//', 'kind': 'op',     'expr_str': '/',  'display': '//'},
                ],
                [
                    {'text': '1', 'kind': 'number', 'expr_str': '1', 'display': '1'},
                    {'text': '2', 'kind': 'number', 'expr_str': '2', 'display': '2'},
                    {'text': '3', 'kind': 'number', 'expr_str': '3', 'display': '3'},
                    {'text': '^', 'kind': 'op',     'expr_str': '^', 'display': '^'},
                    {'text': '=', 'kind': 'eq',     'expr_str': '=', 'display': '='},
                ],
                [
                    {'text': '0', 'kind': 'number',     'expr_str': '0',         'display': '0'},
                    {'text': 'e', 'kind': 'irrational', 'expr_str': 'E',         'display': 'e',
                     '_meta': {'exact_expr': 'E', 'showing_decimal': False}},
                    {'text': 'log', 'kind': 'tool', 'expr_str': 'log',       'display': 'log'},
                    {'text': 'ln',  'kind': 'tool', 'expr_str': 'ln',        'display': 'ln'},
                    {'text': '!',   'kind': 'tool', 'expr_str': 'factorial', 'display': '!'},
                ],
            ],
        },
        {
            ...
            'rows': [
                [
                    {'text': 'sin',  'kind': 'tool', 'expr_str': 'sin',       'display': 'sin'},
                    {'text': 'cos',  'kind': 'tool', 'expr_str': 'cos',       'display': 'cos'},
                    {'text': 'tan',  'kind': 'tool', 'expr_str': 'tan',       'display': 'tan'},
                    {'text': 'int',  'kind': 'tool', 'expr_str': 'integrate', 'display': 'int'},
                    {'text': 'd/dx', 'kind': 'tool', 'expr_str': 'diff',      'display': 'd/dx'},
                ],
                [
                    {'text': '|x|', 'kind': 'tool', 'expr_str': 'abs',        'display': '|x|'},
                    {'text': '+-',  'kind': 'tool', 'expr_str': 'negate',     'display': '+-'},
                    {'text': '%',   'kind': 'op',   'expr_str': '%',           'display': '%'},
                    {'text': 'sum', 'kind': 'tool', 'expr_str': 'sum',        'display': 'sum'},
                    {'text': 'RAD', 'kind': 'tool', 'expr_str': 'deg_rad',    'display': 'RAD'},
                ],
                [
                    {'text': '(',    'kind': 'op',   'expr_str': '(',            'display': '('},
                    {'text': ')',    'kind': 'op',   'expr_str': ')',            'display': ')'},
                    {'text': 'mod',  'kind': 'op',   'expr_str': '%',            'display': 'mod'},
                    {'text': 'rand', 'kind': 'tool', 'expr_str': 'random',       'display': 'rand'},
                    {'text': 'a-b',  'kind': 'tool', 'expr_str': 'random_range', 'display': 'a-b'},
                ],
            ],
        },
    ]
